        ...
        <div id="container">
            ...
            <div className="bg-[url('/ApplicationBg.png')] bg-repeat-y bg-center bg-[length:100%_auto]">
                ...
                >
                    ...
                    >
                        ...
                        <li>
                            ...
                            antioxidants) against oxidation, prolonging shelf
                            life naturally.
                        </li>
                        <li>
                            <span className="text-[#AB808D]">
                ...
                <div className="flex flex-col md:flex-row gap-5 justify-between pt-17 pb-20 pl-5 pr-5 lg:pl-16 lg:pr-16">
                    ...
                    <div>
                        ...
                        >
                            ...
                            polyunsaturated-rich oils into solid-like matrices
                            using plant proteins. This enables healthier fat
                            systems and mimic the functionality of saturated and
                            hydrogenated fats — without compromising texture,
                ...
                >
                    ...
                    >
                        <li>
                            ...
                            – Replaces saturated and trans fats with PUFA-rich
                            oils.
                        </li>
                        <li>
                            <span className="text-[#D8AE02]">
                        ...
                        <li>
                            ...
                            – Tunable firmness, spreadability and melting points
                            for precise product design.
                        </li>
                        <li>
                            <span className="text-[#D8AE02]">
                ...
                >
                    ...
                    first tasty and healthy vegan cheese, rich in omega-3 fats.
                    We use plant proteins to gently encapsulate flaxseed oil
                    into the oleogel. It’s eco-friendly and packed with healthy
                ...
                <div className="flex flex-col md:flex-row gap-5 justify-between pt-8 lg:pt-30 pb-8 lg:pb-15 pl-5 pr-5 lg:pl-16 lg:pr-16">
                    ...
                    <div>
                        ...
                        >
                            ...
                            beauty and food, but also opening opportunities in
                            wellness and nutraceuticals. By structuring natural
                            oils into stable, solid carriers, we can protect and
                            deliver sensitive bioactive compounds.
                        </p>
                    </div>
                </div>
                <div className="mb-5 mb-8 lg:mb-15">
                    <RoundTabs tabText={wellnessTabText} lineColor="#679BE8" />
                </div>
                <section className="relative w-full h-[397px] md:h-[496px] lg:h-[503px]">
                    <Image
                ...
                >
                    ...
                    >
                        ...
                        <li>
                            <span className="text-[#679BE8]">Stability</span> –
