                ...
                <div className="2xl:w-[1440px] mx-auto">
                    <div className="relative w-full px-4 md:px-10">
                        <div className="pt-23 pb-15 text-center">
                            ...
                            >
                                The world needs healthy, efficient and
                                sustainable fats
                            </h2>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        cause of death is heart attack and
                                        stroke, triggered by trans/saturated
                                        fats
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <p
                                        className={`text-center font-light text-white ${lato.className}`}
                                    >
                                        absorption of lipophilic bioactives by
                                        human body, e.g. curcumin, CBD
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center md:flex-row pt-20">
                            ...
                            <div className="flex flex-2 flex-col pt-15 md:pt-0 pl-0 md:pl-8 lg:pl-25">
                                ...
                                <div className="px-5">
                                    ...
                                    >
                                        Majority of cosmetics rely on
                                        fossil-derived or animal fats, while
                                        edible fats are packed with trans and
                                        saturated lipids.
                                    </p>
                                    <p
                                        id="plantOils"
                                    ...
                                    >
                                        ...
                                        polyunsaturated fats, offer a
                                        sustainable bioactive alternative.
                                        However, fluidity and instability of
                                        oils drastically limit their
                    ...
                    text-center font-light text-white ${lato.className}`}
                        ...
                        <div className="flex flex-col md:flex-row mt-14 gap-5 lg:gap-22">
                            ...
                            <div className="flex flex-2 flex-col items-center w-full md:w-auto">
                                ...
                                >
                                    ...
                                    oils by protecting from oxidation and UV.
                                </div>
                            </div>
                            ...
                            <div className="flex flex-3 flex-col items-center w-full md:w-auto">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        proteins and turn liquid oils into
                        ...
                        {!isMobile && (
                            <>
                                ...
                                >
                                    Every Olexir oleogel is plant protein based.
                                    To amplify sustainability, we also offer an
                                    upcycled feedstock route that recovers
                                    proteins from industrial side streams.
                                </div>
                        ...
                        <div className="flex relative flex-col md:flex-row mt-20 gap-10 justify-between ">
                            ...
                            <div className="flex flex-[1_1_0] flex-col items-center">
                                ...
                                <div className="max-w-[400px] pt-4 md:pt-8">
                                    ...
                                    >
                                        Field-grown protein sources are used for
                                        our fully plant-based oleogels.
                                    </span>
                                </div>
                            </div>
                            <div className="flex flex-[1_1_0] flex-col items-center">
                                ...
                                <div className="max-w-[400px] pt-4 md:pt-8">
                                    ...
                                    <span
                                        className={`text-[16px] lg:text-[24px] text-white font-light ${lato.className}`}
                                    >
                                        Oilseed cakes and protein-rich
                                        by-products can be used by our
                                        technology.
                                    </span>
                                </div>
                            </div>
                            <div className="flex flex-[1_1_0] flex-col items-center">
                                ...
                                <div className="max-w-[400px] pt-4 md:pt-8">
                                    ...
                                    >
                                        ...
                                        concentrates are available for
                                        oleogelation.
                                    </span>
                                </div>
                            </div>
