...
const CarouselItem = React.memo(function CarouselItem({
    ...
    let cardSize = isBigCarousel
        ? 'w-[300px] h-[300px] sm:w-[420px] sm:h-[420px] md:w-[450px] md:h-[450px] lg:w-[360px] lg:h-[360px] xl:w-[365px] xl:h-[365px] 2xl:w-[400px] 2xl:h-[400px] 3xl:w-[500px] 3xl:h-[500px]'
